    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="<?= media(); ?>/images/avatar.png" alt="User Image">
        <div>
          <p class="app-sidebar__user-name">Carlos Rodriguez</p>
      ...
      <ul class="app-menu">
        ...
        <li class="treeview">
          ...
          </i><span class="app-menu__label">Usuarios</span><i class="treeview-indicator fa fa-angle-right"></i></a>
        ...
        <li>
          ...
          <i class="app-menu__icon fa fa-address-card-o" aria-hidden="true"></i>
        ...
        <li>
          ...
          <span class="app-menu__label">Cerrar sesion</span></a>
        </li>
      </ul>
    </aside>